  ...
  return (
    <Section
      ...
      sectionContent={
        <div>
          <p>
            Durch Anklicken eines Links auf einen B-Plan oder ein
            FNP-Änderungsverfahren in der Info-Box oder eines PDF-Symbols in der
            Info-Box wird in einer neuen Registerkarte Ihres Browsers ein
            Dokumentenviewer geöffnet, in dem die Dokumente zu dem B-Plan bzw.
            ...
            <Icon name="chevron-right" /> <i>"nächste Seite"</i> in der
            Werkzeugleiste am oberen Rand des Dokumentenviewers können Sie in
            mehrseitigen Dokumenten vor- und zurückblättern.
          </p>
          <p>
            Beim FNP werden immer mehrere Dokumente angezeigt, nämlich der
            Erläuterungsbericht und die vier Anlagen. Zu den
            FNP-Änderungsverfahren gibt nur dann separate verfahrensbegleitende
            Zusatzdokumente, wenn es sich um Änderungen gemäß §2 ff. BauGB
            handelt. Bei Berichtigungen gemäß § 13a BauGB werden die Dokumente
            zur FNP-Berichtigung bei dem B-Plan-Verfahren geführt, das der
            Anlass für die Berichtigung war. Sowohl bei den B-Plan-Verfahren wie
            auch bei den FNP-Änderungsverfahren werden die
          ...
          <p>
            ...
            Dokumentdarstellung. Der FNP-Inspektor benutzt maximal zwei
            Dokumentenviewer auf zwei Registerkarten ihres Browsers, einen für
            FNP-Dokumente und einen für B-Plan-Dokumente. Wenn Sie also z. B.
            für ein neues FNP-Änderungsverfahren zur Dokumentbetrachtung
...
export default DokumenteBetrachten;
