...
export const layerMap = {
  luftbild: {
    ...
    description: ``,
    inhalt: `Kartendienst (WMS) der Stadt Wuppertal. Datengrundlage
            ...
            Stadtkarte 2.0 und Kartenschrift aus der Stadtkarte 2.0. Details s. Hintergrundkarte Stadtplan).`,
